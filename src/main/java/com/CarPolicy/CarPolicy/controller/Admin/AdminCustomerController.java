...
public class AdminCustomerController {
	...
	public AdminCustomerController(BuildingService buildingService,RoleService roleService,CustomerService customerService, CarService carService, ModelMapper modelMapper,
	...
	{
		CustomerDto customerDto = customerService.getCustomerById(customerId);
		List<CarDto> carDtos = carService.getCarsByCustomerId(customerId);
		List<BuildingDto> buildingDtos = buildingService. getBuildingsByCustomerId(customerId);
