...
public class AdminPolicyTypeController {
	...
	@GetMapping("/admin/carPolicyTypes/getAll")
			                 ...
			                 Model model)
	{
		if(!result.hasErrors())
		{
			...
			{
				if(policyTypeDto.getName().equals("Car Policy Type"))
				{
					return "redirect:/admin/carPolicyTypes/getAll";
				}
				else if(policyTypeDto.getName().equals("Dask Policy Type"))
				{
					return "redirect:/admin/daskPolicyTypes/getAll";
				}
	...
	@GetMapping("/admin/carPolicyTypes/delete/{policyTypeId}")
	public String deleteCarPolicyType(@PathVariable int policyTypeId)
	{
		policyTypeService.deletePolicyType(policyTypeId);
		return "redirect:/admin/carPolicyTypes/getAll";
	}
	
	@GetMapping("/admin/daskPolicyTypes/delete/{policyTypeId}")
	public String deleteDaskPolicyType(@PathVariable int policyTypeId)
	{
		policyTypeService.deletePolicyType(policyTypeId);
		return "redirect:/admin/daskPolicyTypes/getAll";
	}
	...
	@GetMapping("/admin/carPolicyTypes/policies/{policyTypeId}/search/{pageNumber}")
	public String searchCarsByPolicy(@RequestParam(value="query") String query,@PathVariable("policyTypeId") int policyTypeId,@PathVariable("pageNumber") int pageNumber,
            Model model)
     {
		PolicyTypeDto policyTypeDto = policyTypeService.getPolicyTypeById(policyTypeId);
		if(policyTypeDto!=null)
