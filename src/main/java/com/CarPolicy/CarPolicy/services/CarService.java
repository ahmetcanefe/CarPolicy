...
//			newCar.setCustomer(customer);
			...
			Car newCar = new Car();
			newCar.setModel(model);
			newCar.setLicensePlate(carDto.getLicensePlate().toUpperCase());
			newCar.setColor(carDto.getColor().toUpperCase());
	    	newCar.setManufacturingYear(carDto.getManufacturingYear());
